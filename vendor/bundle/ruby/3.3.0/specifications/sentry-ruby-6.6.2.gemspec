# -*- encoding: utf-8 -*-
# stub: sentry-ruby 6.6.2 ruby lib
...
Gem::Specification.new do |s|
  ...
  s.metadata = { "bug_tracker_uri" => "https://github.com/getsentry/sentry-ruby/issues", "changelog_uri" => "https://github.com/getsentry/sentry-ruby/blob/6.6.2/CHANGELOG.md", "documentation_uri" => "http://www.rubydoc.info/gems/sentry-ruby/6.6.2", "homepage_uri" => "https://github.com/getsentry/sentry-ruby/tree/6.6.2/sentry-ruby", "source_code_uri" => "https://github.com/getsentry/sentry-ruby/tree/6.6.2/sentry-ruby" } if s.respond_to? :metadata=
  ...
  s.homepage = "https://github.com/getsentry/sentry-ruby/tree/6.6.2/sentry-ruby".freeze
